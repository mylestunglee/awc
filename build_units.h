...
#ifndef EXPOSE_BUILD_UNITS_INTERNAL
...
void inputs_initialise_capturables(const struct game* const,
                                   struct bap_inputs* const);
void inputs_initialise(const struct game* const, struct bap_inputs* const);
