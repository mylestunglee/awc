...
void grid_clear_player_territory(tile_t[grid_size][grid_size], player_t[grid_size][grid_size], const player_t);
...
void grid_explore_recursive(struct game* const, const bool, const bool, const energy_t);
