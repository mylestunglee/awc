...
bool load_money(const char* const, const char* const,
...
bool load_unit(const char* const, const char* const, const model_t,
               struct units* const, struct list* const);
...
void save_unit(const struct unit* const unit, const player_t turn,
               FILE* const file);
void save_units(const struct units* const, const player_t turn, FILE* const);
